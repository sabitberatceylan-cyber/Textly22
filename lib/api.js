...
export function hikayeEkle(sunucuAdres, kullanici, sifre, veriBase64, mimeTuru, metin, yaziKatmani) {
  return govdeliIstek(
    `${sunucuAdres}/hikaye-ekle?kullanici=${encodeURIComponent(kullanici)}&sifre=${encodeURIComponent(sifre)}`,
    { veriBase64, mimeTuru, metin, yaziKatmani }
  );
}

export function hikayeEkleUrl(sunucuAdres, kullanici, sifre, medyaUrl, medyaTuru, metin, yaziKatmani) {
  return govdeliIstek(
    `${sunucuAdres}/hikaye-ekle-url?kullanici=${encodeURIComponent(kullanici)}&sifre=${encodeURIComponent(sifre)}`,
    { medyaUrl, medyaTuru, metin, yaziKatmani }
  );
}
